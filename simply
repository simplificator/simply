...
class HelpCommand < Command
  ...
  def perform
    ...
    puts
    puts 'Usage: ./bin/simply.rb <command>'
    puts
...
# Run from the project root with ./bin/simply.rb #{command_string}
#
...
class TestCommand < Command
  ...
  def perform
    puts "PERFORM TEST #{executable_path}"
    system(executable_path)
  end
end
...
class Simply
  ...
  COMMAND_EXECUTABLE_DIRECTORY = "#{BASE_DIRECTORY}/simply/"
